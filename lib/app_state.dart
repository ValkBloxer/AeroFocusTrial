...
class AppState extends ChangeNotifier {
  ...
  Future<void> initialize() async {
    ...
    if (prefs.isNotEmpty) {
      ...
      cinematic3dFlight = prefs['cinematic3dFlight'] as bool? ?? true;
  ...
  void toggleCinematicFlight(bool value) {
    cinematic3dFlight = value;
    _persistPrefs();
    notifyListeners();
  }
  ...
  Future<void> _persistPrefs() async {
    await _storage.saveUserPrefs({
      ...
      'cinematic3dFlight': cinematic3dFlight,
